...
export default function OpenInvestmentCard({
  ...
  return (
    <>
      <Card
        className={`w-full ${
          type === "morpho" ? "h-24" : "h-20"
        } bg-[#102E37] border border-[#B5CAA9/20] grid grid-cols-[1fr_1.1fr_0.9fr_0.8fr_1fr_1fr_1fr_2.6fr] gap-4 items-center p-3`}
      >
        ...
        <div className="flex flex-row gap-2 justify-end">
          {type === "morpho" ? (
            <Button
              className="font-medium py-[1.5rem] px-[2rem] text-[1rem] bg-light-green cursor-pointer"
              onClick={() =>
                window.open("https://app.morpho.org/base/dashboard", "_blank")
              }
            >
              Manage
            </Button>
